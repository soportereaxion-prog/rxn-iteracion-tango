...
if (isset($_POST['selectEmpresa'])) {
        setcookie("ultima_empresa", $_POST['selectEmpresa']);
}
...

{
        ...
        public function seleccionoFactura()
        {
                ...
                //$matriz_nomenclatura = ;
?>
                <select class="selector" name="selectFactura" id="e1">
                        <option value=""></option>
                        <?php
                        /*Carga el array al ultimo metodo llamado*/
                        //$this->selec_factura();

                        // echo "<script>alert('Entro por aca');</script>";
                        $this->selec_Factura($_POST['selectEmpresa'],$_POST['fech1'],$_POST['fech2']);
                        ...
                        foreach ($this->factura as $factu) {
                                ...
                                if ($factu['N_COMP'] == $_POST['selectFactura']) {
                        ?>
                                        <option value="<?php echo $factu['N_COMP']; ?>" selected="selected"><?php echo $factu['N_COMP']; ?></option>
                                <?php
                                } else {
                                ?>
        ...
        ?>
                <select name="selectEmpresa" id="e2">
                        ...
                        <option value="<?php echo !empty($_COOKIE['ultima_empresa']) ? $_COOKIE['ultima_empresa'] : ''; ?>">
                                <?php echo !empty($_COOKIE['ultima_empresa']) ? $_COOKIE['ultima_empresa'] : ''; ?>
                        </option>
                        <?php
                        //Carga el array al ultimo metodo llamado
                        $this->selec_empresa();
