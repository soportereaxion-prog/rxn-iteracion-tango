...
<link rel="stylesheet" href="jquery/smoothness/jquery-ui.css">
  ...
  (function( $ ) {
    $.widget( "custom.combobox", {
      ...
      _createShowAllButton: function() {
        ...
        $( "<a>" )
          .attr( "tabIndex", -1 )
          .attr( "title", "Mostrar todos los valores" )
          .tooltip()
          .appendTo( this.wrapper )
          .button({
            icons: {
...
/*Metodo Java para apuntar a los valores de Total menos horas normales*/
    function obtenerResta()
            {
                document.getElementById('hsCincuenta').value=parseFloat(document.getElementById('totalH').value)-parseFloat(document.getElementById('hsNormales').value);
            }
    function obtenerRestaImputa()
            {
                document.getElementById('totalImpu').value=parseFloat(document.getElementById('hastaImpu').value)-parseFloat(document.getElementById('desdeImpu').value);
            }
            
    //function obtenerRestaHsCincuenta()
      //      {
      //          document.getElementById('hsCincuentaImpu').value=parseFloat(document.getElementById('hReal').value)-parseFloat(document.getElementById('totalImpuCalc').value);
      //     }
